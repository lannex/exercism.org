...
def add_me_to_the_queue(
    ...
    queue = express_queue.copy() if ticket_type == 1 else normal_queue.copy()
...
def add_me_with_my_friends(queue: list[str], index: int, person_name: str) -> list[str]:
    ...
    cloned_queue = queue.copy()
    cloned_queue.insert(index, person_name)
    return cloned_queue
...
def remove_the_mean_person(queue: list[str], person_name: str) -> list[str]:
    ...
    cloned_queue = queue.copy()
    cloned_queue.remove(person_name)
    return cloned_queue
